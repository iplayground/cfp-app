class Comment < ActiveRecord::Base
  ...
  def notify_with_slack
    ...
    msg = Slack::Notifier::Util::LinkFormatter.format("Proposal: #{proposal.title} has new comment #{Rails.application.routes.url_helpers.reviewer_event_proposal_url(event_id: proposal.event.id, uuid: proposal.uuid, host: "cfp.iplayground.io")}")
    notifier.ping(msg)
  end
